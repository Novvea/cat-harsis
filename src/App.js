...
{/*             <ellipse cx="70.6947" cy="82.8365" rx="11" ry="15.7655" transform="rotate(-79.4397 70.6947 82.8365)" />
          ...
          <g id='eyes'>
            <path d="M69.5 93C76.4036 93 82 88.299 82 82.5C82 76.701 76.4036 72 69.5 72C62.5964 72 57 76.701 57 82.5C57 88.299 62.5964 93 69.5 93Z" fill="#335760"/>
            <path d="M122.5 93C129.404 93 135 88.299 135 82.5C135 76.701 129.404 72 122.5 72C115.596 72 110 76.701 110 82.5C110 88.299 115.596 93 122.5 93Z" fill="#335760"/>
          </g>
          <g id='nose' fill="#C49999">
          ...
          <g id='pawn_l' fill="#BBA099">
            <ellipse cx="62.5" cy="206.5" rx="14.5" ry="17.5" />
          </g>
          <g id='pawn_r'>
            <ellipse cx="129.5" cy="206.5" rx="14.5" ry="17.5" fill="#BB995A"/>
          </g>
        </svg>
      </div>
    </div>
